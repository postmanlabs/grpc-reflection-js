...
const PROTO_DIR = path.join(__dirname, '../fixtures', 'v1alpha');
...
const DESCRIPTOR_SET_PATH = path.join(PROTO_DIR, 'server_descriptor.protoset');
...
module.exports.start = async function start(port = 0) {
  ...
  grpcServer.addService(widgetsProto.WidgetService.service, widgetServiceImpl);
